...
func init() {
	...
	tables["Match"] = MatchTableInfo
	tables["PlayerH"] = PlayerHTableInfo
	tables["Players"] = PlayersTableInfo
	tables["SequelizeMeta"] = SequelizeMetaTableInfo
	tables["Team"] = TeamTableInfo
}
